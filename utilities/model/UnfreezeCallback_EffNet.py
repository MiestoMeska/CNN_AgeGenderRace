...
class UnfreezeCallbackEffNet(pl.Callback):
    ...
    def unfreeze_layers(self, pl_module, num_layers=None):
        ...
        print(f"✅ Layers unfrozen: {unfrozen_part}, optimizer reinitialized, learning rate updated.")
