...
class UnfreezeCallback(pl.Callback):
    ...
    def on_validation_end(self, trainer, pl_module):
        ...
        if self.best_val_loss is None:
            ...
            if self.wait >= self.patience and not self.unfrozen_once:
                print("Unfreezing 2 layers due to plateau in validation loss.")
                self.unfreeze_layers(pl_module, num_layers=2)
    ...
    def unfreeze_layers(self, pl_module, num_layers=None):
        ...
        """
        layers_to_unfreeze = [pl_module.resnet.layer4, pl_module.resnet.layer3]
        ...
        new_optimizer = torch.optim.AdamW([
            {'params': pl_module.resnet.parameters()},
