...
class ResNetMultiOutputCNN_extended(pl.LightningModule):
    def __init__(self, class_weights, lr=1e-3, n_classes_gender=2, n_classes_race=5, n_classes_age=9):
        super(ResNetMultiOutputCNN_extended, self).__init__()
    ...
    def configure_optimizers(self):
        optimizer = optim.AdamW(
            ...
            {'params': self.age_classifier.parameters()}],
